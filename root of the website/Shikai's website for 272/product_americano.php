...
<?php
setcookie("American", time(),time()+60*60*24*5);
?>
            ...
            <div class="product-item-title d-flex">
                <div class="bg-faded p-5 d-flex ml-auto rounded" >
                    <h2 class="section-heading mb-0">
                        ...
                        <span class="section-heading-lower">American Coffee</span>
                    </h2>
                </div>
            </div>
            <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="img/americano.jpg" alt="">
            <div class="product-item-description d-flex mr-auto">
                <div class="bg-faded p-5 rounded">
                    <p class="mb-0">Taste like American Coffee!</p>
                </div>
            </div>
        </div>
    </div>
